...
create policy "allow_all_workouts" on workouts for all using (true)
with
    check (true);
...
create table if not exists exercises (
    ...
    rest_seconds_before_next_exercise integer,
    notes text,
    created_at timestamptz not null default now()
);
...
create policy "allow_all_exercises" on exercises for all using (true)
with
    check (true);
...
create policy "allow_all_workout_sessions" on workout_sessions for all using (true)
with
    check (true);
...
create policy "allow_all_completed_sets" on completed_sets for all using (true)
with
    check (true);
...
create policy "allow_all_meal_plan_entries" on meal_plan_entries for all using (true)
with
    check (true);
...
create policy "allow_all_body_photos" on body_photos for all using (true)
with
    check (true);
...
create policy "allow_all_food_items" on food_items for all using (true)
with
    check (true);
...
create policy "allow_all_weight_records" on weight_records for all using (true)
with
    check (true);